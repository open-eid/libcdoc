 ...
 */
CDOC_EXPORT int add_logger(std::shared_ptr<ILogger> logger);
 ...
 */
CDOC_EXPORT void remove_logger(int cookie);
 ...
 */
CDOC_EXPORT void set_min_loglevel(LogLevel minLogLevel);
